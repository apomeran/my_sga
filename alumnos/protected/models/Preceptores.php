...
class Preceptores extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('idpreceptor', 'required'),
			array('idpreceptor', 'numerical', 'integerOnly'=>true),
			array('nombre, apellido', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idpreceptor, nombre, apellido', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('idpreceptor',$this->idpreceptor);
