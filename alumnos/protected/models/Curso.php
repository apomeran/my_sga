...
class Curso extends CActiveRecord {
    ...
    public function relations() {
        ...
        return array(
            ...
            'cursoMaterias' => array(self::HAS_MANY, 'CursoMateria', 'curso'),
            'alumnoMateriaPrevias' => array(self::HAS_MANY, 'AlumnoMateriaPrevia', 'curso'),
            'titular0' => array(self::BELONGS_TO, 'Docentes', 'titular'),
        );
    }
    ...
    public function getCode() {
        return "(" . $this->nivel->nombre . ") " . $this->ano_academico . $this->division_salita . " " . $this->turno->codigo;
    }
